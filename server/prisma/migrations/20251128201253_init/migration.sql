...
-- CreateEnum
CREATE TYPE "ReportTargetType" AS ENUM ('ITEM', 'COMMENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Report_reporterId_targetType_itemId_commentId_key" ON "Report"("reporterId", "targetType", "itemId", "commentId");
